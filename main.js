...
function buildTable() {
  ...
  <tr>
    <td class="menu" id="window-title-bar" colspan="${size}">
      <div id="window-title"><img src="images/mine-menu-icon.png"> Minesweeper Online</div>
...
boardEl.addEventListener('contextmenu', function(e) {
  e.preventDefault();
  var cellEl = e.target.tagName === 'IMG' ? e.target.parentElement : e.target;
  if (cellEl.classList.contains('game-cell')) {
    var row = +cellEl.dataset.row;
    var col = +cellEl.dataset.col;
    var cell = board[row][col];
